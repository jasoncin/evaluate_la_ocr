        ...
        for pair in list_pair:
            try:
                ...
                if pair['iou'] > 0.01:
                    ...
                    dict_info['is_la_ok'] = (dict_info['gt']['text_pr'] == dict_info['pred']['text']) or (pair['iou'] > 0.8)
...
def add_keytype(content):
    for region in content["attributes"]["_via_img_metadata"]["regions"]:
        region_attributes = region['region_attributes']
        if "header" in region_attributes["note"]:
            region['region_attributes']["key_type"] = "key"
            region['region_attributes']["formal_key"] = "invoice_id"
        else:
            region['region_attributes']["key_type"] = "other"
            region['region_attributes']["formal_key"] = ""
    return content
...
if __name__ == '__main__':
    ...
    LIST_INPUT_DATA = [
        {
            'PRED_DIR': '/mnt/ai_filestore/home/jason/laocrkv/LaOcr/output/Test_v4_Original',
            'OUT_DIR': '/mnt/ai_filestore/home/jason/laocrkv/LaOcr/output/Test_v4_Original/evaluate',
            'GT_DIR': '/mnt/ai_filestore/home/jason/laocrkv/LaOcr/input/Test_v4/labels',
            'IMAGE_DIR': '/mnt/ai_filestore/home/jason/laocrkv/LaOcr/input/Test_v4/images',
            'IS_RUN': False
        },
        {
            'PRED_DIR': 'pred_data/can_dc_896/ocr_output',
            'OUT_DIR': 'pred_data/can_dc_896/evaluate_header_key',
            'GT_DIR': 'gt_data/test_v4/labels',
            'IMAGE_DIR': 'gt_data/test_v4/images',            
            'IS_RUN': False
        },
        {
            'PRED_DIR': 'pred_data/val_v4_can_jeff_tokyomr/ocr_output',
            'OUT_DIR': 'pred_data/val_v4_can_jeff_tokyomr/evaluate_header_key',
            'GT_DIR': 'gt_data/val_v4/labels',
            'IMAGE_DIR': 'gt_data/val_v4/images',            
            'IS_RUN': True
        }

        # {
        #     'PRED_DIR': 'C:\\Users\\lucas\\Documents\\Cinnamon\\Projects\\Prudential\\Result_data\\FullReport\\191010\\Graph_Prudential_Private_test_1_FF_caches\\caches\\ocr_process\\Prudential_Private_test_1\\CannetOcr_',
        #     'OUT_DIR': 'output\\output_191010_private1',
        #     'GT_DIR': 'C:\\Users\\lucas\\Documents\\Cinnamon\\Projects\\Prudential\\Input_data\\1570510324_Prudential_Private_test_1\\labels',
        #     'IMAGE_DIR': 'C:\\Users\\lucas\\Documents\\Cinnamon\\Projects\\Prudential\\Input_data\\1570510324_Prudential_Private_test_1\\images',
        #     'IS_RUN': False
        # },
        # {
        #     'PRED_DIR': 'C:\\Users\\lucas\\Documents\\Cinnamon\\Projects\\Prudential\\Result_data\\FullReport\\191010\\Graph_Prudential_Private_test_2_FF_caches\\caches\\ocr_process\\Prudential_Private_test_2\\CannetOcr_',
        #     'OUT_DIR': 'output\\output_191010_private2',
        #     'GT_DIR': 'C:\\Users\\lucas\\Documents\\Cinnamon\\Projects\\Prudential\\Input_data\\1570510306_Prudential_Private_test_2\\labels',
        #     'IMAGE_DIR': 'C:\\Users\\lucas\\Documents\\Cinnamon\\Projects\\Prudential\\Input_data\\1570510306_Prudential_Private_test_2\\images',
        #     'IS_RUN': False
        # },
        # {
        #     'PRED_DIR': 'C:\\Users\\lucas\\Documents\\Cinnamon\\Projects\\Prudential\\Code\\git_full_flow_prudential\\prj_prudential\\assets\\caches\\ocr_process\\Prudential_Validation_Test_190927_FF_191010\\CannetOcr_',
        #     'OUT_DIR': 'output\\output_191010_val190927',
        #     'GT_DIR': 'test',
        #     'IMAGE_DIR': 'C:\\Users\\lucas\\Documents\\Cinnamon\\Projects\\Prudential\\Code\\git_full_flow_prudential\\prj_prudential\\assets\\data\\inputs\\Prudential_Validation_Test_190927\\images',
        #     'IS_RUN': True
        # },
    ]
    IMG_EXTENSION = '.jpg'
